...
Full detail: [`Insights_Recommendations.docx`](reports/Insights_Recommendations.docx)
---
## Tech Stack
...
| File | Description |
| --- | --- |
| [`Superstore.pbix`](dashboard/Superstore.pbix) | Power BI project file |
| [`Global_Superstore_PDF_export.pdf`](dashboard/Global_Superstore_PDF_export.pdf) | Dashboard export |
| [`dashboard_screenshot.png`](dashboard/dashboard_screenshot.png) | Dashboard screenshot |
| [`Global_Superstore2_cleaned.csv`](data/Global_Superstore2_cleaned.csv) | Cleaned source dataset |
| [`BI_Overview_Report.docx`](reports/BI_Overview_Report.docx) | Business Intelligence overview report |
| [`Insights_Recommendations.docx`](reports/Insights_Recommendations.docx) | Business insights, risks, opportunities, and recommendations |
| [`Executive_Summary_Report.docx`](reports/Executive_Summary_Report.docx) | Executive summary report |
| [`Project_Log.md`](docs/Project_Log.md) | Full project change log — every data cleaning and design decision, with reasoning |
---
## Dashboard Contents
...
---
## Methodology Note
Every data cleaning decision, chart choice, and formatting fix in this project is documented, with the reasoning behind it, in [`Project_Log.md`](docs/Project_Log.md). This includes catching and correcting a mid project cross filtering bug where dashboard totals briefly didn't match the source data, verified and fixed against an independent Python calculation.
---
## Author
