...
![Dashboard Screenshot](Global_Superstore_Image.png)
...
Full detail: [`Insights_Recommendations.docx`](Insights_Recommendations.docx)
...
| [`Global_Superstore_PDF_export.pdf`](Global_Superstore_PDF_export.pdf) | Dashboard export |
| [`Global_Superstore_Image.png`](Global_Superstore_Image.png) | Dashboard screenshot |
| [`Global_Superstore2_cleaned.csv`](Global_Superstore2_cleaned.csv) | Cleaned source dataset |
| [`BI_Overview_Report.docx`](BI_Overview_Report.docx) | Business Intelligence overview report |
| [`Insights_Recommendations.docx`](Insights_Recommendations.docx) | Business insights, risks, opportunities, and recommendations |
| [`Executive_Summary_Report.docx`](Executive_Summary_Report.docx) | Executive summary report |
| [`doc_CHANGELOG.md`](doc_CHANGELOG.md) | Full project change log — every data cleaning and design decision, with reasoning |
...
Every data cleaning decision, chart choice, and formatting fix in this project is documented, with the reasoning behind it, in [`doc_CHANGELOG.md`](doc_CHANGELOG.md). This includes catching and correcting a mid project cross filtering bug where dashboard totals briefly didn't match the source data, verified and fixed against an independent Python calculation.
